            ...
            <nav class="mt-4 d-flex justify-content-center">
                <ul class="pagination">
                    ...
                    <?php if ($startPage > 1): ?>
                        <li class="page-item">
                            <a class="page-link"
                                href="?page=<?php echo $startPage - 1; ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&laquo;</a>
                        </li>
                    <?php endif; ?>
                    <!-- 페이지 번호 -->
                    ...
                    <?php if ($endPage < $totalPages): ?>
                        <li class="page-item">
                            <a class="page-link"
                                href="?page=<?php echo $endPage + 1; ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&raquo;</a>
                        </li>
                    <?php endif; ?>
                    <!-- 마지막으로 -->
