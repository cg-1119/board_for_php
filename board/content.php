...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            ...
            <small class="text-muted">작성자: <?php echo htmlspecialchars($username); ?> | 작성일: <?php echo $created_at; ?>
            ...
            <ul class="list-group mb-4">
                <?php foreach ($comments as $comment) : ?>
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <!-- 오른쪽: 수정/삭제 버튼 -->
                        <div class="text-end">
                            <a href="modify_comment.php?comment_id=<?php echo $comment['id']; ?>&post_id=<?php echo $postId; ?>" class="text-black">수정</a>
                            |
                            <a href="delete_comment.php?comment_id=<?php echo $comment['id']; ?>&post_id=<?php echo $postId; ?>" class="text-black">삭제</a>
                        </div>
                    </li>
                <?php endforeach; ?>
            </ul>
            ...
            <?php foreach ($posts as $post) : ?>
                <li class="list-group-item d-flex justify-content-between align-items-center post-item
                    ...
                    <div>
                        ...
                        <a href="content.php?post_id=<?php echo $post['id']; ?>&page=<?php echo $current_page; ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>" class="text-black">
        ...
        <nav class="mt-4 d-flex justify-content-center">
            <ul class="pagination">
                <li class="page-item <?php echo $current_page == 1 ? 'disabled' : ''; ?>">
                    <a class="page-link" href="content.php?post_id=<?php echo htmlspecialchars($currentPostId); ?>&page=1&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&laquo;&laquo;</a>
                </li>
                <li class="page-item <?php echo $current_page == 1 ? 'disabled' : ''; ?>">
                    <a class="page-link" href="content.php?post_id=<?php echo htmlspecialchars($currentPostId); ?>&page=<?php echo max(1, $current_page - 1); ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&laquo;</a>
                </li>
                <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                    <li class="page-item <?php echo $current_page == $i ? 'active' : ''; ?>">
                        <a class="page-link" href="content.php?post_id=<?php echo htmlspecialchars($currentPostId); ?>&page=<?php echo $i; ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
                <li class="page-item <?php echo $current_page == $totalPages ? 'disabled' : ''; ?>">
                    <a class="page-link" href="content.php?post_id=<?php echo htmlspecialchars($currentPostId); ?>&page=<?php echo min($totalPages, $current_page + 1); ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&raquo;</a>
                </li>
                <li class="page-item <?php echo $current_page == $totalPages ? 'disabled' : ''; ?>">
                    <a class="page-link" href="content.php?post_id=<?php echo htmlspecialchars($currentPostId); ?>&page=<?php echo $totalPages; ?>&search=<?php echo htmlspecialchars($search); ?>&search_field=<?php echo htmlspecialchars($searchField); ?>">&raquo;&raquo;</a>
                </li>
            </ul>
        </nav>
    <?php else : ?>
